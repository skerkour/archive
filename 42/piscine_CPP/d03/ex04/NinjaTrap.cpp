...
/*   Updated: 2015/06/19 23:07:24 by skerkour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	NinjaTrap::ninjaShoebox(const FragTrap& frag) const
{
	std::cout << "NINJA : " << _name
		<< " put his SHADOW BLADE in the " << frag.name()
		<< " FRAG weak's body, causing 42 Damage points" << std::endl;
}
...
{
	std::cout << "NINJA : " << _name
		<< " put his SHADOW BLADE in the " << ninja.name()
		<< " NINJA weak's body, causing 42 Damage points" << std::endl;
}
