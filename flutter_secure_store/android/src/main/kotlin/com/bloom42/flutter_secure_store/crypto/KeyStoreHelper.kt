package com.bloom42.flutter_secure_store.crypto
...
class KeyStoreHelper {
  companion object {
    ...
    private const val MASTER_KEY_ALIAS = "com.bloom42.flutter_secure_store.secret"
    ...
    fun encryptKeyValue(key: String, value: String): String {
      ...
      return Base64.encodeToString(cipher.iv + ciphertext, Base64.NO_WRAP or Base64.NO_PADDING)
    }
    ...
    fun decryptKeyValue(key: String, ciphertext: String): ByteArray {
      ...
      val cipher = Cipher.getInstance(AES_GCM_NO_PADDING)
      cipher.init(Cipher.DECRYPT_MODE, secretKey, GCMParameterSpec(TAG_SIZE, iv.toByteArray()))
      cipher.updateAAD(key.toByteArray())
