...
/*   Updated: 2015/06/19 23:25:07 by skerkour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_attack	FragTrap::_random_vh_attacks[6] = {
	{"toxic fart", 42},
	{"fatal thought", 20},
	{"mortal knife", 36},
	{"test", 29},
	...
	_name("anonymous")
{
	...
	std::cout << "start bootup sequence. His little name is : "
		<< _name << ". That sentence had too many syllables! APOLOGISSSSE!" << std::endl;
}
...
void	FragTrap::takeDamage(unsigned int amount)
{
	if (amount <= _armor_damage_reduction) {
		std::cout << "No damages taken, " << _name << "'s armor is good. " <<
			"I AM FUNNYBOT. AWKWAAAARD ! AWKWAAAAARD !" << std::endl;
		return ;
	} else {
