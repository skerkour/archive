...
//!     let t = "s = \"value\"\n";
//!
//!     let u: Value = sane::from_str(t).unwrap();
//!
...
#[doc(hidden)]
pub const NAME: &'static str = "$__sane_private_Spanned";
#[doc(hidden)]
pub const START: &'static str = "$__sane_private_start";
#[doc(hidden)]
pub const END: &'static str = "$__sane_private_end";
#[doc(hidden)]
pub const VALUE: &'static str = "$__sane_private_value";
        ...
        D: de::Deserializer<'de>,
    {
            ...
            T: de::Deserialize<'de>,
        {
            ...
            fn expecting(&self, formatter: &mut fmt::Formatter) -> fmt::Result {
                formatter.write_str("a SANE spanned")
            }
